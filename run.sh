...
#SBATCH --job-name=bin-all
#SBATCH --qos=short        # Request Quality of Service. Default is 'short' (maximum run time: 4 hours)
#SBATCH --time=5:00:00      # Request run time (wall-clock). Default is 1 minute
...
CMD_ARGS="-I input/cris_all.txt --gc_file input/cris_all_gc.txt -c 64 -F BIN -b beds/genome_bins/hg38_1mb_filtered_bins.bed"
