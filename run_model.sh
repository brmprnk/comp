...
#SBATCH --time=33:38:00      # Request run time (wall-clock). Default is 1 minute
...
apptainer exec --writable-tmpfs --pwd /opt/app --containall \
	...
	--bind extracted_features/:/opt/app/extracted_features/ \
		...
		-c 64 -t 'PANCAN' --metadata_file accessory_files/jiang_metadata.csv \
		-o nested_cv_results_jiang
